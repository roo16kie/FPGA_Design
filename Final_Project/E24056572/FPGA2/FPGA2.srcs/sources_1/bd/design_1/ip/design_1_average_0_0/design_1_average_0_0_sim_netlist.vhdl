...
--               F:/fpga_data/project/FPGA2/FPGA2.srcs/sources_1/bd/design_1/ip/design_1_average_0_0/design_1_average_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_average_0_0_average is
  ...
  signal Sum_0 : STD_LOGIC_VECTOR ( 35 to 35 );
  ...
  signal shiffter : STD_LOGIC_VECTOR ( 9 downto 1 );
  signal \shiffter[9]_i_2_n_0\ : STD_LOGIC;
  signal \shiffter[9]_i_3_n_0\ : STD_LOGIC;
  signal \shiffter[9]_i_4_n_0\ : STD_LOGIC;
  signal \shiffter[9]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \magnitude_buf[0][0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \magnitude_buf[0][10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \magnitude_buf[0][11]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \magnitude_buf[0][12]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][16]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[0][20]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \magnitude_buf[0][21]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][24]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \magnitude_buf[0][25]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \magnitude_buf[0][26]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \magnitude_buf[0][27]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[0][30]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \magnitude_buf[0][31]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \magnitude_buf[0][3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \magnitude_buf[0][4]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \magnitude_buf[0][5]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][9]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \magnitude_buf[1][31]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \magnitude_buf[2][31]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \magnitude_buf[3][31]_i_2\ : label is "soft_lutpair2";
begin
...
\Sum[42]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\Sum[42]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\magnitude_buf[0][31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000A080"
        ...
        port map (
      I0 => \magnitude_buf[0][31]_i_3_n_0\,
      I1 => valid_buf1_carry_n_0,
      I2 => valid_in,
      I3 => index(9),
      I4 => \counter_reg_n_0_[2]\,
...
\magnitude_buf[0][31]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \counter_reg_n_0_[2]\,
      I2 => \counter_reg_n_0_[1]\,
      I3 => \magnitude_buf[0][31]_i_4_n_0\,
      I4 => \counter_reg_n_0_[0]\,
      I5 => \magnitude_buf[0][31]_i_5_n_0\,
      O => p_0_in(31)
    );
...
\magnitude_buf[0][31]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\magnitude_buf[1][31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0200"
    )
        port map (
      I0 => \shiffter[9]_i_3_n_0\,
      I1 => \magnitude_buf[1][31]_i_2_n_0\,
      I2 => \counter_reg_n_0_[1]\,
      I3 => \counter_reg_n_0_[0]\,
      O => \magnitude_buf[1][31]_i_1_n_0\
    );
\magnitude_buf[1][31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AFBF"
    )
        port map (
...
\magnitude_buf[2][31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000A080"
        ...
        port map (
      I0 => \magnitude_buf[2][31]_i_2_n_0\,
      I1 => valid_buf1_carry_n_0,
      I2 => valid_in,
      I3 => index(9),
      I4 => \counter_reg_n_0_[2]\,
...
\magnitude_buf[3][31]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02000000"
        ...
        port map (
      I0 => \shiffter[9]_i_3_n_0\,
      I1 => \magnitude_buf[3][31]_i_2_n_0\,
...
\magnitude_buf[5][31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \counter_reg_n_0_[1]\,
      I1 => \magnitude_buf[5][31]_i_2_n_0\,
      O => \magnitude_buf[5][31]_i_1_n_0\
    );
\magnitude_buf[5][31]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\magnitude_buf[7][31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\shiffter[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
      I0 => valid_in,
      I1 => index(9),
      I2 => \shiffter[9]_i_3_n_0\,
      O => shiffter_1
    );
\shiffter[9]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => valid_buf1_carry_n_0,
      I1 => valid_in,
      O => \shiffter[9]_i_2_n_0\
    );
\shiffter[9]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
      I0 => index(8),
      I1 => index(9),
      I2 => \shiffter[9]_i_4_n_0\,
      I3 => \shiffter[9]_i_5_n_0\,
      O => \shiffter[9]_i_3_n_0\
    );
\shiffter[9]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index(7),
      I3 => index(6),
      O => \shiffter[9]_i_4_n_0\
    );
\shiffter[9]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index(3),
      I3 => index(0),
      O => \shiffter[9]_i_5_n_0\
    );
\shiffter_reg[1]\: unisim.vcomponents.FDSE
     port map (
      C => s00_axi_aclk,
      CE => \shiffter[9]_i_2_n_0\,
      D => '0',
      Q => shiffter(1),
      S => shiffter_1
    );
\shiffter_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \shiffter[9]_i_2_n_0\,
      D => shiffter(1),
...
valid_buf1_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
valid_buf1_carry_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00009009"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_average_0_0_average_v2_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_average_0_0_average_v2_0_S00_AXI : entity is "average_v2_0_S00_AXI";
end design_1_average_0_0_average_v2_0_S00_AXI;

architecture STRUCTURE of design_1_average_0_0_average_v2_0_S00_AXI is
...
ave: entity work.design_1_average_0_0_average
     port map (
      ...
      index(9 downto 0) => index(9 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_average_0_0_average_v2_0 is
  port (
    s00_axi_wready : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_average_0_0_average_v2_0 : entity is "average_v2_0";
end design_1_average_0_0_average_v2_0;

architecture STRUCTURE of design_1_average_0_0_average_v2_0 is
begin
average_v2_0_S00_AXI_inst: entity work.design_1_average_0_0_average_v2_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      index(9 downto 0) => index(9 downto 0),
...
entity design_1_average_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_average_0_0 : entity is "design_1_average_0_0,average_v2_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_average_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_average_0_0 : entity is "average_v2_0,Vivado 2018.2";
...
inst: entity work.design_1_average_0_0_average_v2_0
     port map (
