...
#Audio system controller fron FPGA

#Audio adau1761 I2C address and data, clk pin
...
#Audio serial data from FPGA
#ADC_S DATA, DAC_S DATA, Serial Data Port Bit Clock, Serial Data Port Frame Clock
set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVCMOS33} [get_ports au_dout_r]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports au_din_r]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports au_lrclk_r]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports au_bclk_r]

#Audio External Master clock

set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports au_mclk_r]
...
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { ws2812 }]; #IO_L21N_T3_DQS_34 Sch=ar[9]
...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { ar_scl }]; #IO_L24N_T3_34 Sch=ar_scl
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { ar_sda }]; #IO_L24P_T3_34 Sch=ar_sda
