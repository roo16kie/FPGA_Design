...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average is
  ...
  signal Sum1_in : STD_LOGIC_VECTOR ( 41 downto 0 );
  ...
  signal \Sum[41]_i_6_n_0\ : STD_LOGIC;
  ...
  signal Sum_0 : STD_LOGIC_VECTOR ( 38 to 38 );
  ...
  signal \Sum_reg[41]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_Sum_reg[41]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_Sum_reg[41]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
\Sum[41]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"08FF"
    )
        port map (
...
\Sum[41]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Sum[41]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55510000"
    )
        port map (
...
\Sum[41]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55510000"
    )
        port map (
...
\Sum_reg[41]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \Sum_reg[39]_i_1_n_0\,
      CO(3 downto 1) => \NLW_Sum_reg[41]_i_3_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \Sum_reg[41]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_Sum_reg[41]_i_3_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => Sum1_in(41 downto 40),
      S(3 downto 2) => B"00",
      S(1) => \Sum[41]_i_5_n_0\,
      S(0) => \Sum[41]_i_6_n_0\
    );
