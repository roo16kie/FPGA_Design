...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average is
  ...
  signal shiffter : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal \shiffter[8]_i_2_n_0\ : STD_LOGIC;
  signal \shiffter[8]_i_3_n_0\ : STD_LOGIC;
  signal \shiffter[8]_i_4_n_0\ : STD_LOGIC;
  ...
  signal NLW_valid_buf1_carry_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][10]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \magnitude_buf[0][11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \magnitude_buf[0][12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \magnitude_buf[0][13]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \magnitude_buf[0][14]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][19]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \magnitude_buf[0][1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \magnitude_buf[0][20]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \magnitude_buf[0][21]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \magnitude_buf[0][22]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \magnitude_buf[0][23]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \magnitude_buf[0][24]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \magnitude_buf[0][25]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][28]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \magnitude_buf[0][29]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \magnitude_buf[0][2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[0][30]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \magnitude_buf[0][31]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \magnitude_buf[0][3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[0][4]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \magnitude_buf[0][5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \magnitude_buf[0][6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \magnitude_buf[0][7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \magnitude_buf[0][8]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[3][31]_i_2\ : label is "soft_lutpair1";
begin
...
\Sum[41]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => valid_buf1_carry_n_1,
      I2 => index(8),
      I3 => \shiffter[8]_i_3_n_0\,
      O => Sum_0(39)
    );
\Sum[41]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\Sum[41]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\Sum[41]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\shiffter[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
      I0 => valid_in,
      I1 => index(8),
      I2 => \shiffter[8]_i_3_n_0\,
      O => shiffter_1
    );
\shiffter[8]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => valid_buf1_carry_n_1,
      I1 => valid_in,
      O => \shiffter[8]_i_2_n_0\
    );
\shiffter[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BFFFFFFFFFFFFFFF"
    )
        port map (
      I0 => \shiffter[8]_i_4_n_0\,
      I1 => index(1),
      I2 => index(0),
      I3 => index(3),
      I4 => index(2),
      I5 => index(7),
      O => \shiffter[8]_i_3_n_0\
    );
\shiffter[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => index(5),
      I3 => index(4),
      O => \shiffter[8]_i_4_n_0\
    );
\shiffter_reg[0]\: unisim.vcomponents.FDSE
     port map (
      C => s00_axi_aclk,
      CE => \shiffter[8]_i_2_n_0\,
      D => '0',
      Q => shiffter(0),
      S => shiffter_1
    );
\shiffter_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \shiffter[8]_i_2_n_0\,
      D => shiffter(0),
...
valid_buf1_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => NLW_valid_buf1_carry_CO_UNCONNECTED(3),
      ...
      S(3) => '0',
      S(2) => valid_buf1_carry_i_1_n_0,
      S(1) => valid_buf1_carry_i_2_n_0,
      S(0) => valid_buf1_carry_i_3_n_0
    );
...
ave: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average
     port map (
      ...
      index(8 downto 0) => index(8 downto 0),
