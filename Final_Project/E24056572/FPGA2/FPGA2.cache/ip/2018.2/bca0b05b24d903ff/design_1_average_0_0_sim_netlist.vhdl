...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average is
  ...
  signal Sum1_in : STD_LOGIC_VECTOR ( 43 downto 0 );
  ...
  signal \Sum[43]_i_4_n_0\ : STD_LOGIC;
  signal \Sum[43]_i_5_n_0\ : STD_LOGIC;
  signal \Sum[43]_i_6_n_0\ : STD_LOGIC;
  signal \Sum[43]_i_7_n_0\ : STD_LOGIC;
  signal \Sum[43]_i_8_n_0\ : STD_LOGIC;
  signal \Sum[43]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \Sum_reg[43]_i_3_n_1\ : STD_LOGIC;
  signal \Sum_reg[43]_i_3_n_2\ : STD_LOGIC;
  signal \Sum_reg[43]_i_3_n_3\ : STD_LOGIC;
  ...
  signal \NLW_Sum_reg[43]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\Sum[43]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"40FF"
    )
        port map (
...
\Sum[43]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2220"
    )
        port map (
...
\Sum[43]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\Sum[43]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Sum[43]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Sum[43]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Sum[43]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Sum[43]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\Sum_reg[43]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \Sum_reg[39]_i_1_n_0\,
      CO(3) => \NLW_Sum_reg[43]_i_3_CO_UNCONNECTED\(3),
      CO(2) => \Sum_reg[43]_i_3_n_1\,
      CO(1) => \Sum_reg[43]_i_3_n_2\,
      CO(0) => \Sum_reg[43]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => Sum1_in(43 downto 40),
      S(3) => \Sum[43]_i_5_n_0\,
      S(2) => \Sum[43]_i_6_n_0\,
      S(1) => \Sum[43]_i_7_n_0\,
      S(0) => \Sum[43]_i_8_n_0\
