...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average is
  ...
  signal Sum_0 : STD_LOGIC_VECTOR ( 36 to 36 );
  ...
  signal \magnitude_buf[4][32]_i_2_n_0\ : STD_LOGIC;
  signal \magnitude_buf[5][32]_i_1_n_0\ : STD_LOGIC;
  signal \magnitude_buf[6][32]_i_1_n_0\ : STD_LOGIC;
  signal \magnitude_buf[6][32]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \magnitude_buf[0][12]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \magnitude_buf[0][13]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \magnitude_buf[0][14]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \magnitude_buf[0][15]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][18]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \magnitude_buf[0][19]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[0][22]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \magnitude_buf[0][23]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \magnitude_buf[0][24]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \magnitude_buf[0][25]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \magnitude_buf[0][26]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \magnitude_buf[0][27]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \magnitude_buf[0][28]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \magnitude_buf[0][29]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \magnitude_buf[0][30]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \magnitude_buf[0][31]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \magnitude_buf[0][32]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \magnitude_buf[0][32]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \magnitude_buf[0][4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \magnitude_buf[0][5]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \magnitude_buf[2][32]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[4][32]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \magnitude_buf[6][32]_i_2\ : label is "soft_lutpair16";
begin
...
\Sum[39]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55510000"
    )
        port map (
...
\Sum[39]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"55510000"
    )
        port map (
...
\magnitude_buf[0][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => valid_in,
      I4 => \counter_reg_n_0_[0]\,
      I5 => \magnitude_buf[0][32]_i_3_n_0\,
      O => magnitude_buf
    );
...
\magnitude_buf[0][32]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\magnitude_buf[1][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\magnitude_buf[2][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000E00000000000"
    )
        port map (
      ...
      I3 => valid_in,
      I4 => \counter_reg_n_0_[0]\,
      I5 => \magnitude_buf[2][32]_i_2_n_0\,
      O => \magnitude_buf[2][32]_i_1_n_0\
    );
\magnitude_buf[2][32]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\magnitude_buf[3][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E000000000000000"
    )
        port map (
...
\magnitude_buf[4][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000E00000000000"
    )
        port map (
      ...
      I3 => valid_in,
      I4 => \counter_reg_n_0_[0]\,
      I5 => \magnitude_buf[4][32]_i_2_n_0\,
      O => \magnitude_buf[4][32]_i_1_n_0\
    );
\magnitude_buf[4][32]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \counter_reg_n_0_[2]\,
      I1 => \counter_reg_n_0_[1]\,
      O => \magnitude_buf[4][32]_i_2_n_0\
    );
\magnitude_buf[5][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E000000000000000"
    )
        port map (
...
\magnitude_buf[6][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000E00000000000"
    )
        port map (
      ...
      I3 => valid_in,
      I4 => \counter_reg_n_0_[0]\,
      I5 => \magnitude_buf[6][32]_i_2_n_0\,
      O => \magnitude_buf[6][32]_i_1_n_0\
    );
\magnitude_buf[6][32]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => \counter_reg_n_0_[2]\,
      I1 => \counter_reg_n_0_[1]\,
      O => \magnitude_buf[6][32]_i_2_n_0\
    );
\magnitude_buf[7][32]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E000000000000000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_average_v2_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of axi_awready0 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of axi_wready0 : label is "soft_lutpair19";
begin
