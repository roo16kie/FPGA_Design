...
HD_PWD='F:/fpga_data/project/FPGA2/FPGA2.runs/design_1_i2s_receive_new_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_i2s_receive_new_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_i2s_receive_new_0_1.tcl
