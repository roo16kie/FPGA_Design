...
begin
    case(sw)
        ...
        begin
            ...
            begin
                if(count==3'd0) begin led4_r <= 1'b1; led4_g <= 1'b0; led4_b<= 1'b0; led5_r <= 1'b1;  led5_g <= 1'b0; led5_b <= 1'b0;  end
        ...
        default: 
            begin  
             led4_r <= 1'b0; led4_g <= 1'b0; led4_b <= 1'b0; led5_r <= 1'b0;  led5_g <= 1'b0; led5_b <= 1'b0;end
    endcase      
end

assign out = ((data_in>rand) ? 2'd1 : ((data_in < rand) ? 2'd3 : 2'd2));
assign dataout = {2'b00,sw,out}; //1 + 2  + 3 
assign led = {1'b0,count};
