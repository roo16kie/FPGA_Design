...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.creg_5 {true} \
   CONFIG.dreg_3 {true} \
   CONFIG.instruction1 {(A+D)*B} \
   CONFIG.instruction2 {(A+D)*B+C} \
   CONFIG.mreg_5 {true} \
   CONFIG.opreg_3 {true} \
   CONFIG.opreg_4 {true} \
   CONFIG.opreg_5 {true} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins DSP48E1_axi_wrapper_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net DSP48E1_axi_wrapper_0_axi_wrapper_A_o [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_A_o] [get_bd_pins xbip_dsp48_macro_0/A]
  connect_bd_net -net DSP48E1_axi_wrapper_0_axi_wrapper_B_o [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_B_o] [get_bd_pins xbip_dsp48_macro_0/B]
  connect_bd_net -net DSP48E1_axi_wrapper_0_axi_wrapper_C_o [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_C_o] [get_bd_pins xbip_dsp48_macro_0/C]
  connect_bd_net -net DSP48E1_axi_wrapper_0_axi_wrapper_D_o [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_D_o] [get_bd_pins xbip_dsp48_macro_0/D]
  connect_bd_net -net DSP48E1_axi_wrapper_0_axi_wrapper_SEL_o [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_SEL_o] [get_bd_pins xbip_dsp48_macro_0/SEL]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DSP48E1_axi_wrapper_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xbip_dsp48_macro_0/CLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins DSP48E1_axi_wrapper_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xbip_dsp48_macro_0_P [get_bd_pins DSP48E1_axi_wrapper_0/axi_wrapper_P_i] [get_bd_pins xbip_dsp48_macro_0/P]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DSP48E1_axi_wrapper_0/S00_AXI/S00_AXI_reg] SEG_DSP48E1_axi_wrapper_0_S00_AXI_reg
