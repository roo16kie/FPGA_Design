...
#
# Generated by export_simulation on Sat Jan 12 23:34:23 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './FFT_system.sh' script.

./FFT_system.sh -reset_run
...
./FFT_system.sh -noclean_files

For more information on the script, please type './FFT_system.sh -help'.
