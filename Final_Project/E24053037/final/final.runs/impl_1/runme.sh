...
HD_PWD='C:/Users/Leo/Desktop/FPGA/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_system_wrapper.tcl -notrace
