...
HD_PWD='C:/Users/Leo/Desktop/FPGA/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_system_wrapper.tcl
