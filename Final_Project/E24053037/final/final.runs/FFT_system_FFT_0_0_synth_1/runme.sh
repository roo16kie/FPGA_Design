...
HD_PWD='C:/Users/Leo/Desktop/FPGA/final/final.runs/FFT_system_FFT_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_system_FFT_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_system_FFT_0_0.tcl
