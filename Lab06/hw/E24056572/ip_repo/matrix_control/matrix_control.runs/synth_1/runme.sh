...
HD_PWD='C:/Users/ricky/Desktop/Xilinx-designtool/project/ip_repo/matrix_control/matrix_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_processor_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_processor_ctrl.tcl
