...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal mem_data_in_C0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \mem_address_A[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \mem_address_B[2]_i_1\ : label is "soft_lutpair3";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \mem_byte_we_C_reg[3]\ : label is "LD";
  attribute SOFT_HLUTNM of \mem_byte_we_C_reg[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \mem_byte_we_C_reg[3]_i_3\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_2\ : label is "soft_lutpair1";
begin
  \^clk\ <= clk;
...
\s_nstate_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5FCC"
    )
        port map (
