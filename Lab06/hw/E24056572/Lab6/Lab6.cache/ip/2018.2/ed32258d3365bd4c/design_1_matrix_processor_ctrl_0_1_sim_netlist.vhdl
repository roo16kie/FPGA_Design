...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal \^mem_byte_we_c\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal \s_nstate_reg[1]_i_2_n_1\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_2_n_2\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_2_n_3\ : STD_LOGIC;
  ...
  signal \NLW_s_nstate_reg[1]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_s_nstate_reg[1]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \mem_address_A[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \mem_address_A[10]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \mem_address_A[13]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \mem_address_A[14]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \mem_address_A[15]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \mem_address_A[16]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \mem_address_A[17]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \mem_address_A[18]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \mem_address_A[19]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \mem_address_A[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \mem_address_A[20]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \mem_address_A[21]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \mem_address_A[22]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \mem_address_A[23]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \mem_address_A[24]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \mem_address_A[25]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \mem_address_A[26]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \mem_address_A[27]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \mem_address_A[28]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \mem_address_A[29]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \mem_address_A[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \mem_address_A[30]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \mem_address_A[31]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \mem_address_A[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \mem_address_A[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \mem_address_A[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \mem_address_A[6]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \mem_address_A[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \mem_address_A[8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \mem_address_A[9]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \ope_nstate_reg[1]_i_1\ : label is "soft_lutpair18";
  attribute XILINX_LEGACY_PRIM of \ope_nstate_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \ope_nstate_reg[2]_i_1\ : label is "soft_lutpair18";
  attribute XILINX_LEGACY_PRIM of \s_nstate_reg[0]\ : label is "LD";
  attribute SOFT_HLUTNM of \s_nstate_reg[0]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \s_nstate_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_1\ : label is "soft_lutpair1";
begin
  \^clk\ <= clk;
...
\mem_byte_we_C_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => '0',
      D => ope_cstate(1),
      G => \mem_byte_we_C_reg[0]_i_1_n_0\,
      GE => '1',
      Q => \^mem_byte_we_c\(0)
    );
...
\ope_nstate_reg[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ope_cstate(1),
      I2 => \s_nstate_reg[1]_i_2_n_1\,
      I3 => s_cstate(0),
      I4 => s_cstate(1),
      I5 => ope_cstate(0),
      O => \ope_nstate_reg[2]_i_3_n_0\
    );
\ope_nstate_reg[2]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00005554"
    )
        port map (
...
\s_nstate_reg[1]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_nstate_reg[1]_i_3_n_0\,
      CO(3) => \NLW_s_nstate_reg[1]_i_2_CO_UNCONNECTED\(3),
      CO(2) => \s_nstate_reg[1]_i_2_n_1\,
      CO(1) => \s_nstate_reg[1]_i_2_n_2\,
      CO(0) => \s_nstate_reg[1]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_s_nstate_reg[1]_i_2_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
      S(2) => \s_nstate_reg[1]_i_4_n_0\,
      S(1) => \s_nstate_reg[1]_i_5_n_0\,
      S(0) => \s_nstate_reg[1]_i_6_n_0\
    );
\s_nstate_reg[1]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_nstate_reg[1]_i_7_n_0\,
      CO(3) => \s_nstate_reg[1]_i_3_n_0\,
      ...
      S(3) => \s_nstate_reg[1]_i_8_n_0\,
      S(2) => \s_nstate_reg[1]_i_9_n_0\,
      S(1) => \s_nstate_reg[1]_i_10_n_0\,
      S(0) => \s_nstate_reg[1]_i_11_n_0\
    );
...
\s_nstate_reg[1]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\s_nstate_reg[1]_i_7\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \s_nstate_reg[1]_i_12_n_0\,
      S(2) => \s_nstate_reg[1]_i_13_n_0\,
      S(1) => \s_nstate_reg[1]_i_14_n_0\,
      S(0) => \s_nstate_reg[1]_i_15_n_0\
    );
\s_nstate_reg[1]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
