...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transpose is
  port (
    ...
    \s_cstate_reg[1]_1\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
\mem_address_C[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFA2A2A2A2A2A2A2"
        ...
        port map (
      I0 => Q(2),
      I1 => \s_cstate_reg[1]_1\(0),
      I2 => offset(0),
      I3 => mem_address_C0(0),
      I4 => \cstate_reg[1]\,
      I5 => \s_cstate_reg[1]_1\(1),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \matrix_elements[5]_i_16\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \matrix_elements[5]_i_17\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_10\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_13\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_14\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_15\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_16\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_17\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_18\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_22\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_23\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_24\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_25\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_26\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \mem_address_A[2]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_6\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \nstate_reg[1]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \nstate_reg[1]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \nstate_reg[1]_i_4\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_2\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_6\ : label is "soft_lutpair14";
...
\mem_byte_we_C_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAA8"
    )
        port map (
      I0 => \mem_byte_we_C_reg[3]_i_6_n_0\,
      I1 => \mem_byte_we_C_reg[3]_i_5_n_0\,
...
\mem_byte_we_C_reg[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFF088888880"
        ...
        port map (
      I0 => \mem_address_A[2]_i_2_n_0\,
      I1 => s_cstate(1),
      I2 => \mem_byte_we_C_reg[3]_i_3_n_0\,
      I3 => \mem_byte_we_C_reg[3]_i_4_n_0\,
      I4 => \mem_byte_we_C_reg[3]_i_5_n_0\,
      I5 => \mem_byte_we_C_reg[3]_i_6_n_0\,
...
\mem_byte_we_C_reg[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFF700000000"
        ...
        port map (
      I0 => cstate(2),
      I1 => \mem_byte_we_C_reg[3]_i_9_n_0\,
      I2 => \address_cursor_reg_n_0_[1]\,
      I3 => \address_cursor_reg_n_0_[2]\,
      I4 => \address_cursor_reg_n_0_[3]\,
      I5 => s_cstate(1),
      O => \mem_byte_we_C_reg[3]_i_6_n_0\
    );
\mem_byte_we_C_reg[3]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
tra: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transpose
     port map (
      ...
      \s_cstate_reg[1]_1\(1 downto 0) => s_cstate(1 downto 0),
