...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal \address_cursor[6]_i_2_n_0\ : STD_LOGIC;
  signal \address_cursor[6]_i_3_n_0\ : STD_LOGIC;
  signal \address_cursor[6]_i_4_n_0\ : STD_LOGIC;
  ...
  signal s_nstate : STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute SOFT_HLUTNM of \address_cursor[0]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \cstate[0]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \mem_byte_we_C_reg[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_cstate[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_cstate[1]_i_1\ : label is "soft_lutpair3";
begin
  \^clk\ <= clk;
...
\address_cursor[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4FFF8000"
    )
        port map (
...
\address_cursor[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
\address_cursor[6]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\address_cursor[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\cstate[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cstate[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\cstate[0]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7DFFFF7D"
    )
        port map (
...
\matrix_elements[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\mem_address_C[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000087"
    )
        port map (
...
\s_cstate[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
\s_cstate[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
