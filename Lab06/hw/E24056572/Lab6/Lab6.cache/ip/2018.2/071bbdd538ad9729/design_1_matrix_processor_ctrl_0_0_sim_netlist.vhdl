...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal \mem_address_C_reg[31]_i_3_n_5\ : STD_LOGIC;
  signal \mem_address_C_reg[31]_i_3_n_6\ : STD_LOGIC;
  signal \mem_address_C_reg[31]_i_3_n_7\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \address_cursor[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \address_cursor[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \address_cursor[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \address_cursor[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \address_cursor[6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \address_cursor[7]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \address_cursor[7]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cstate[0]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cstate[0]_i_7\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cstate[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cstate[2]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \mem_byte_we_C_reg[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_cstate[0]_i_2\ : label is "soft_lutpair7";
...
\address_cursor[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3F80"
    )
        port map (
      I0 => s_cstate(0),
      I1 => \mem_address_A[31]_i_2_n_0\,
      I2 => cstate(0),
...
\address_cursor[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\address_cursor[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00010000"
    )
        port map (
...
\cstate[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEEE"
    )
        port map (
      I0 => \cstate[0]_i_2_n_0\,
      I1 => \cstate[0]_i_3_n_0\,
      I2 => cstate(0),
...
\cstate[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \cstate[0]_i_5_n_0\,
      I2 => \cstate[0]_i_6_n_0\,
      I3 => cstate(0),
      I4 => \cstate[0]_i_7_n_0\,
      O => \cstate[0]_i_3_n_0\
    );
\cstate[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFF6FF6"
        ...
        port map (
      I0 => \matrix_elements_reg_n_0_[5]\,
      I1 => \address_cursor_reg_n_0_[5]\,
...
\cstate[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
\cstate[0]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
      I0 => \address_cursor_reg_n_0_[2]\,
      I1 => \matrix_elements_reg_n_0_[2]\,
      I2 => \address_cursor_reg_n_0_[3]\,
      I3 => \matrix_elements_reg_n_0_[3]\,
      O => \cstate[0]_i_6_n_0\
    );
\cstate[0]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\mem_address_A[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\mem_address_C_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => \^clk\,
      CE => mem_address_C0,
      D => \mem_address_C_reg[31]_i_3_n_7\,
      Q => \^mem_address_c\(29),
      R => \mem_address_C[31]_i_1_n_0\
    );
...
\mem_address_C_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => \^clk\,
      CE => mem_address_C0,
      D => \mem_address_C_reg[31]_i_3_n_6\,
      Q => \^mem_address_c\(30),
      R => \mem_address_C[31]_i_1_n_0\
    );
\mem_address_C_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => \^clk\,
      CE => mem_address_C0,
      D => \mem_address_C_reg[31]_i_3_n_5\,
      Q => \^mem_address_c\(31),
      R => \mem_address_C[31]_i_1_n_0\
    );
\mem_address_C_reg[31]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2) => \mem_address_C_reg[31]_i_3_n_5\,
      O(1) => \mem_address_C_reg[31]_i_3_n_6\,
      O(0) => \mem_address_C_reg[31]_i_3_n_7\,
      S(3) => '0',
...
\s_cstate[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => mem_data_out_A(1),
      I2 => mem_data_out_A(2),
      I3 => \cstate[2]_i_2_n_0\,
      O => \s_cstate[0]_i_2_n_0\
    );
\s_cstate[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
