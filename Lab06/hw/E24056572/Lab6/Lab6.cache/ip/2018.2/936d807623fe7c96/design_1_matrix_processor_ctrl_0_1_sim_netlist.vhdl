...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal nstate3 : STD_LOGIC_VECTOR ( 12 downto 1 );
  ...
  signal \s_nstate_reg[1]_i_13_n_1\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_13_n_2\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_13_n_3\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_14_n_2\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_14_n_3\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_14_n_4\ : STD_LOGIC;
  ...
  signal \s_nstate_reg[1]_i_19_n_0\ : STD_LOGIC;
  ...
  signal \s_nstate_reg[1]_i_7_n_1\ : STD_LOGIC;
  signal \s_nstate_reg[1]_i_7_n_2\ : STD_LOGIC;
  ...
  signal \NLW_s_nstate_reg[1]_i_13_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_s_nstate_reg[1]_i_14_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_s_nstate_reg[1]_i_7_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_s_nstate_reg[1]_i_8_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_11\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_12\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_13\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_14\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_16\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_17\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_18\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_20\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_22\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_31\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_32\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_33\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_34\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \mem_address_A[2]_i_2\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \mem_data_in_C[31]_i_6\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \nstate_reg[0]_i_2\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[0]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \s_nstate_reg[0]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \s_nstate_reg[0]_i_5\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_5\ : label is "soft_lutpair13";
...
\mem_byte_we_C_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44444440"
    )
        port map (
...
\mem_byte_we_C_reg[3]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\nstate_reg[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
...
\s_nstate_reg[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => s_cstate(1),
      I2 => s_cstate(2),
      I3 => \s_nstate_reg[1]_i_7_n_0\,
      I4 => cstate(2),
      O => \s_nstate_reg[0]_i_2_n_0\
    );
\s_nstate_reg[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
...
\s_nstate_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => cstate(2),
      I4 => \s_nstate_reg[1]_i_5_n_0\,
      I5 => \s_nstate_reg[1]_i_6_n_0\,
      O => \s_nstate_reg[1]_i_1_n_0\
    );
\s_nstate_reg[1]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      I0 => \matrix_elements_reg_n_0_[6]\,
...
\s_nstate_reg[1]_i_13\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \s_nstate_reg[1]_i_13_n_0\,
      CO(2) => \s_nstate_reg[1]_i_13_n_1\,
      CO(1) => \s_nstate_reg[1]_i_13_n_2\,
      CO(0) => \s_nstate_reg[1]_i_13_n_3\,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_s_nstate_reg[1]_i_13_O_UNCONNECTED\(3 downto 0),
      S(3) => \s_nstate_reg[1]_i_15_n_0\,
      S(2) => \s_nstate_reg[1]_i_16_n_0\,
      S(1) => \s_nstate_reg[1]_i_17_n_0\,
      S(0) => \s_nstate_reg[1]_i_18_n_0\
    );
\s_nstate_reg[1]_i_14\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_nstate_reg[1]_i_19_n_0\,
      CO(3) => \NLW_s_nstate_reg[1]_i_14_CO_UNCONNECTED\(3),
      CO(2) => nstate3(12),
      CO(1) => \s_nstate_reg[1]_i_14_n_2\,
      CO(0) => \s_nstate_reg[1]_i_14_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \s_nstate_reg[1]_i_14_n_4\,
      O(2 downto 0) => nstate3(11 downto 9),
      S(3) => '1',
      S(2) => \matrix_elements_reg_n_0_[11]\,
      S(1) => \matrix_elements_reg_n_0_[10]\,
      S(0) => \matrix_elements_reg_n_0_[9]\
    );
...
\s_nstate_reg[1]_i_19\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \s_nstate_reg[1]_i_19_n_0\,
      CO(2) => \s_nstate_reg[1]_i_19_n_1\,
      CO(1) => \s_nstate_reg[1]_i_19_n_2\,
      CO(0) => \s_nstate_reg[1]_i_19_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => nstate3(8 downto 5),
      S(3) => \matrix_elements_reg_n_0_[8]\,
      S(2) => \matrix_elements_reg_n_0_[7]\,
      S(1) => \matrix_elements_reg_n_0_[6]\,
      S(0) => \matrix_elements_reg_n_0_[5]\
    );
\s_nstate_reg[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\s_nstate_reg[1]_i_20\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => \matrix_elements_reg_n_0_[0]\,
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => nstate3(4 downto 1),
      S(3) => \matrix_elements_reg_n_0_[4]\,
      S(2) => \matrix_elements_reg_n_0_[3]\,
      S(1) => \matrix_elements_reg_n_0_[2]\,
      S(0) => \matrix_elements_reg_n_0_[1]\
    );
...
\s_nstate_reg[1]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\s_nstate_reg[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D003"
    )
        port map (
      I0 => \s_nstate_reg[1]_i_7_n_0\,
      I1 => s_cstate(2),
      I2 => s_cstate(1),
      I3 => s_cstate(0),
...
\s_nstate_reg[1]_i_7\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \s_nstate_reg[1]_i_7_n_0\,
      CO(2) => \s_nstate_reg[1]_i_7_n_1\,
      CO(1) => \s_nstate_reg[1]_i_7_n_2\,
...
\s_nstate_reg[1]_i_8\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_nstate_reg[1]_i_13_n_0\,
      CO(3 downto 1) => \NLW_s_nstate_reg[1]_i_8_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \s_nstate_reg[1]_i_8_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_s_nstate_reg[1]_i_8_O_UNCONNECTED\(3 downto 0),
      S(3 downto 1) => B"000",
      S(0) => \s_nstate_reg[1]_i_14_n_4\
    );
