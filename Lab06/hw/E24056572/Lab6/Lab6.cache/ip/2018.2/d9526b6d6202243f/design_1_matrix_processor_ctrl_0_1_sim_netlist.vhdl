...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  signal \mem_byte_we_C_reg[3]_i_13_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \matrix_elements[5]_i_16\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \matrix_elements[5]_i_17\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_13\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_14\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \nstate_reg[1]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \s_nstate_reg[1]_i_3\ : label is "soft_lutpair2";
...
\matrix_elements[5]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => mem_data_out_A(3),
      I4 => mem_data_out_A(13),
      I5 => \matrix_elements_reg[5]_i_7_n_7\,
...
\matrix_elements[9]_i_16\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9262F808B8487888"
    )
        port map (
...
\matrix_elements[9]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7F1580EA"
    )
        port map (
      I0 => \matrix_elements[9]_i_11_n_0\,
      I1 => mem_data_out_A(8),
      I2 => mem_data_out_A(12),
      I3 => \matrix_elements[9]_i_10_n_0\,
      I4 => \matrix_elements[9]_i_16_n_0\,
...
\matrix_elements[9]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"96666999"
        ...
        port map (
      I0 => \matrix_elements[9]_i_3_n_0\,
      I1 => \matrix_elements[9]_i_10_n_0\,
      I2 => mem_data_out_A(12),
      I3 => mem_data_out_A(8),
...
\mem_byte_we_C_reg[3]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\mem_byte_we_C_reg[3]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \mem_byte_we_C_reg[3]_i_12_n_0\,
      I1 => \mem_byte_we_C_reg[3]_i_13_n_0\,
      I2 => \^mem_address_c\(21),
      I3 => \^mem_address_c\(18),
      I4 => \^mem_address_c\(24),
      I5 => \^mem_address_c\(23),
...
\mem_byte_we_C_reg[3]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\mem_byte_we_C_reg[3]_i_13\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => \^mem_address_c\(17),
      I3 => \^mem_address_c\(14),
      O => \mem_byte_we_C_reg[3]_i_13_n_0\
    );
\mem_byte_we_C_reg[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000004100414115"
    )
        port map (
      I0 => s_cstate(2),
      I1 => s_cstate(1),
...
\mem_byte_we_C_reg[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000002"
        ...
        port map (
      I0 => \mem_byte_we_C_reg[3]_i_7_n_0\,
      I1 => \mem_byte_we_C_reg[3]_i_8_n_0\,
...
\mem_byte_we_C_reg[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\mem_byte_we_C_reg[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => \mem_byte_we_C_reg[3]_i_10_n_0\,
      I1 => \^mem_address_c\(5),
      I2 => \^mem_address_c\(2),
      I3 => \^mem_address_c\(8),
      I4 => \^mem_address_c\(7),
      I5 => \mem_byte_we_C_reg[3]_i_11_n_0\,
