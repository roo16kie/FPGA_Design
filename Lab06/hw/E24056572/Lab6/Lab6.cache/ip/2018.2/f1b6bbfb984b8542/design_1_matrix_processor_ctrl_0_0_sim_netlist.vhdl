...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_10\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_11\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_12\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_13\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_15\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_16\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_20\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \matrix_elements[9]_i_21\ : label is "soft_lutpair4";
...
\matrix_elements[9]_i_17\: unisim.vcomponents.LUT6
    generic map(
...
\matrix_elements[9]_i_18\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6A95956A956A956A"
    )
        port map (
...
\matrix_elements[9]_i_19\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F8808080"
    )
        port map (
...
\matrix_elements[9]_i_21\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
