...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_matrix_processor_ctrl is
  ...
  attribute SOFT_HLUTNM of \mem_address_A[2]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \mem_address_A[3]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mem_address_A[4]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \mem_address_A[7]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \ope_nstate_reg[0]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \ope_nstate_reg[2]_i_1\ : label is "soft_lutpair19";
...
\s_nstate_reg[1]_i_16\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"41000041"
    )
        port map (
