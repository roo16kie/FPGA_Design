...
proc create_root_design { parentCell } {
  ...
  # Create instance: matrix_processor_ctrl_0, and set properties
  set matrix_processor_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:matrix_processor_ctrl:1.0 matrix_processor_ctrl_0 ]
  ...
  connect_bd_intf_net -intf_net matrix_processor_ctrl_0_BRAM_A [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins matrix_processor_ctrl_0/BRAM_A]
  connect_bd_intf_net -intf_net matrix_processor_ctrl_0_BRAM_B [get_bd_intf_pins blk_mem_gen_1/BRAM_PORTB] [get_bd_intf_pins matrix_processor_ctrl_0/BRAM_B]
  connect_bd_intf_net -intf_net matrix_processor_ctrl_0_BRAM_C [get_bd_intf_pins blk_mem_gen_2/BRAM_PORTB] [get_bd_intf_pins matrix_processor_ctrl_0/BRAM_C]
